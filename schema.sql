...
-- FIX #15: index على story_id لتسريع جلب فصول قصة معينة
CREATE INDEX IF NOT EXISTS idx_chapters_story_id ON chapters(story_id);
CREATE INDEX IF NOT EXISTS idx_chapters_status   ON chapters(status);
CREATE INDEX IF NOT EXISTS idx_gen_log_created   ON gen_log(created_at DESC);

-- ── ملاحظة مهمة: عطّل RLS لضمان عمل جميع العمليات ──────────
-- شغّل هذه الأسطر إذا واجهت مشاكل في الكتابة:
